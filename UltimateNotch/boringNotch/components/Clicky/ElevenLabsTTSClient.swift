...
final class ElevenLabsTTSClient {
    private let apiURL = URL(string: "https://api.elevenlabs.io/v1/text-to-speech/21m00Tcm4TlvDq8ikWAM")!
    ...
    func speakText(_ text: String) async throws {
        ...
        request.setValue(Defaults[.elevenLabsAPIKey], forHTTPHeaderField: "xi-api-key")
